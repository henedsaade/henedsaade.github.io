        ...
        <div className= "container-lg" id="page-top">
            ...
            <nav class="navbar navbar-expand-lg navbar-warning fixed-top bg-gradient" id="mainNav" style={navbarStyle}>
                <div className="container">
                    <h1>
                        <a class="navbar-brand js-scroll-trigger" href="#page-top" style={{'font-weight':'bold', 'font-size': '40px', 'font-family':'Verdana, sans-serif', 'color':'rgba(0, 0, 153, 1)'}}>Pet Nest</a>
                    </h1>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#adoption" style={{'font-size':'17px', 'color':'rgba(0, 0, 153, 1)'}}>Animaux disponibles</a>
                            </li>
                            <li class="nav-item">
